...
Begin VB.Form frmProcessBataRpts 
   Appearance      =   0  'Flat
   ...
   End
End
Attribute VB_Name = "frmProcessBataRpts"
...
Dim colFranIDs As VBA.Collection
    ...
    If lstFranchise.SelCount Then
        ...
        strMsg = "Process Bata Reports?" & vbNewLine & strFranSeln & vbNewLine & strDateSeln
        ...
        If MsgBox(strMsg, vbYesNo + vbQuestion + vbDefaultButton2) = vbYes Then
            ...
            strMsg = "Manual Bata Report Processing: " & strFranSeln & " for " & strDateSeln
            ...
            moBataRpts.AddRpts_FranAndDateSeln pColFranIDs:=colFranIDs, _
                                               ...
                                               pDateTo:=dtpTo.Value
            moBataRpts.Process pAddUnProcessed:=False ' Previous line added reports selected for processing
...
Dim strMsg As String
    ...
    strMsg = "Processing " & oRpt.FranName & " - " & oRpt.Name
    If Success Then
...
Private Sub moBataRpts_BeforeRptUpload(oRpt As clsBataRpt, ByVal UploadAttempt As Long)
    StatusBar pMsg:="Processing " & oRpt.FranName & " - " & oRpt.Name & " (attempt " & UploadAttempt & ")", pLog:=False
End Sub
